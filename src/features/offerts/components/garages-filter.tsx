...
import { LocationCategory, GarageFeature } from "@/features/filters/types";
...
export default function GaragesFilter({
  children,
  meta,
  locationCategories,
  features,
      ...
      <div className="w-full flex flex-col gap-6">
        <div className="w-full flex flex-col gap-2 xl:flex-row xl:justify-between">
          <div className="flex items-center gap-6">
            <h1 className="text-2xl md:text-3xl font-bold">{t("garages")}</h1>
            <span className="text-xs md:text-sm text-muted-foreground">
              {t("found")} <strong>{meta.total}</strong> {t("garages")}
            </span>
          </div>
