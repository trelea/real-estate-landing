  ...
  return (
    <section className="relative pt-10 sm:pt-12 h-fit w-full">
      ...
      <div className="w-full px-6 sm:px-11 lg:px-20 flex justify-center items-center">
        <div className="relative h-full z-10 py-8 sm:py-10 flex flex-col justify-between gap-8 sm:gap-10 w-full max-w-7xl">
          <div className="flex justify-center">
            <h1 className="text-center font-semibold text-[30px] sm:text-[35px] text-background text-balance">
              {t("title")}
              <br />
              {t("subtitle")}
            </h1>
