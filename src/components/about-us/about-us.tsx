...
export const AboutUs: React.FC<Props> = ({}) => {
  return (
    <section className="px-6 sm:px-11 lg:px-20 w-full flex justify-center">
      <div className="w-full max-w-7xl pt-20 sm:pt-24 xl:pt-36 xl:flex xl:gap-14">
        <Image
        ...
        <Card className="p-6 sm:p-0 m-0 shadow border/50 rounded-2xl sm:border-none sm:shadow-none xl:flex-1">
          <CardHeader className="m-0 p-0">
            ...
            <CardDescription className="m-0 p-0 text-balance mt-4 sm:mt-6 text-sm sm:text-base">
              ...
              Perspiciatis in rem mollitia delectus totam commodi aperiam
              quaerat eius magnam qui illum recusandae cupiditate reprehenderit
              nesciunt, illo, tempore architecto earum sed ipsum quidem iure
              labore vitae! Est eveniet amet esse veniam! Non expedita dolores
              neque facilis sint quis totam suscipit itaque!
            </CardDescription>
          </CardHeader>
